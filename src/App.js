...
const ALL_ITEMS = [
  ...
  "Anchor Trim Milk 2L",
  "Anchor Blue Milk 1L",
  "Pam's Full Cream Milk 2L",
  "Lewis Road Creamery Milk 1L",
  "Mainland Tasty Cheese 500g",
  "Mainland Edam Cheese 500g",
  "Pam's Cheddar Cheese 500g",
  "Anchor Butter 500g",
  "Pam's Butter 500g",
  "Meadow Fresh Greek Yoghurt 500g",
  "Chobani Greek Yoghurt 500g",
  "Anchor Cream Cheese 250g",
  "Pam's Sour Cream 200g",
  "Eggs Free Range 12pk",
  "Eggs Free Range 6pk",
  "Pam's Eggs 12pk",
  "Vogel's Mixed Grain Bread 700g",
  "Tip Top Sandwich White Bread",
  "Tip Top Wholegrain Bread",
  "Pam's White Bread 700g",
  "Burgen Soy Lin Bread 700g",
  "Wonder White Bread 700g",
  "Tegel Chicken Breast 1kg",
  "Tegel Chicken Thighs 1kg",
  "Tegel Chicken Wings 1kg",
  "Beef Mince 500g",
  "Beef Mince 1kg",
  "Lamb Mince 500g",
  "Pork Sausages 500g",
  ...
  "Pam's Canned Tomatoes 400g",
  "Pam's Chickpeas 400g",
  "Pam's Lentils 400g",
  "Olive Oil 500ml",
  "Sunflower Oil 2L",
  ...
  "Pam's Muesli 750g",
  "Anchor Peanut Butter 380g",
  "Vegemite 220g",
  "Nutella 400g",
  "Charlie's Orange Juice 1L",
  "Pam's Apple Juice 1L",
  "Coca Cola 1.5L",
  "Sprite 1.5L",
  "Water 1.5L",
  "Sparkling Water 1.5L",
  "Nescafe Instant Coffee 100g",
  "Pam's Tea Bags 100pk",
  "Bluebird Chips 150g",
  "Whittaker's Dark Chocolate 250g",
  "Pam's Crackers 250g",
  "Wattie's Tomato Sauce 560g",
  "Pam's Mayonnaise 385g",
  "Pam's Soy Sauce 250ml",
  "Pam's Salt 1kg",
];

const ICONS = {
  "milk": "🥛", "cheese": "🧀", "butter": "🧈", "yoghurt": "🥛",
  "cream": "🥛", "egg": "🥚", "bread": "🍞", "chicken": "🍗",
  "beef": "🥩", "mince": "🥩", "lamb": "🥩", "pork": "🥩",
  "sausage": "🌭", "bacon": "🥓", "salmon": "🐟", "tuna": "🐟",
  "broccoli": "🥦", "cauliflower": "🥦", "carrot": "🥕",
  "potato": "🥔", "kumara": "🍠", "onion": "🧅", "garlic": "🧄",
  "tomato": "🍅", "lettuce": "🥬", "spinach": "🥬", "capsicum": "🫑",
  "cucumber": "🥒", "zucchini": "🥒", "corn": "🌽", "mushroom": "🍄",
  "avocado": "🥑", "apple": "🍎", "banana": "🍌", "orange": "🍊",
  "strawberr": "🍓", "blueberr": "🫐", "grape": "🍇", "kiwi": "🥝",
  "pear": "🍐", "lemon": "🍋", "mango": "🥭", "watermelon": "🍉",
  "rice": "🍚", "pasta": "🍝", "oat": "🌾", "flour": "🌾",
  "sugar": "🍚", "bean": "🫘", "chickpea": "🫘", "lentil": "🫘",
  "oil": "🫙", "cereal": "🌾", "weet": "🌾", "muesli": "🌾",
  "peanut butter": "🥜", "nutella": "🍫", "vegemite": "🫙",
  "juice": "🧃", "cola": "🥤", "sprite": "🥤", "water": "💧",
  "coffee": "☕", "tea": "🍵", "chip": "🍟", "chocolate": "🍫",
  "cracker": "🍘", "sauce": "🍅", "mayo": "🫙", "soy": "🫙",
  "salt": "🧂",
};
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {currentPage === 'shop' && (
        <ShopPage setCurrentPage={setCurrentPage} setOptimisationResult={setOptimisationResult} />
      )}
      {currentPage === 'results' && (
        <ResultsPage setCurrentPage={setCurrentPage} optimisationResult={optimisationResult} />
      )}
      {currentPage === 'report' && (
        <ReportPage setCurrentPage={setCurrentPage} optimisationResult={optimisationResult} />
      )}
    </div>
  );
}
    ...
    <div>
      ...
      <div className="px-8 pb-8 max-w-4xl mx-auto">
        ...
        <div className="text-center mt-6">
          <button onClick={() => setCurrentPage('shop')} className="bg-green-700 text-white px-8 py-3 rounded-xl font-medium">
      ...
      <div className="col-span-2">
        ...
        <div className="relative mb-4">
          <div className="flex gap-3">
            ...
            />
            <button onClick={() => addItem()} className="bg-green-100 text-green-700 border border-green-300 px-4 py-2 rounded-xl text-sm font-medium whitespace-nowrap">
              + Add
            </button>
          </div>
          ...
          <div className="border border-gray-200 rounded-xl overflow-hidden mb-4">
            {items.map((item, i) => (
              <div key={item.id} className={`flex items-center gap-3 px-4 py-3 bg-white ${i < items.length - 1 ? 'border-b border-gray-100' : ''}`}>
                ...
                <button onClick={() => removeItem(item.id)} className="text-gray-300 hover:text-red-400 text-xl ml-1 leading-none">×</button>
              </div>
            ))}
          </div>
        )}
        ...
        <div className="mb-6">
          ...
          <div className="flex gap-2 flex-wrap">
            {['No preference', 'Vegetarian', 'Vegan', 'Gluten free', 'Dairy free', 'Halal'].map((tag, i) => (
              <span key={i} className={`px-3 py-1 rounded-full text-xs cursor-pointer border ${i === 0 ? 'bg-green-50 text-green-700 border-green-300' : 'text-gray-500 border-gray-200 hover:bg-gray-50'}`}>{tag}</span>
            ))}
          </div>
        </div>
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-6 grid grid-cols-3 gap-6">
      ...
      <div>
        ...
        <div className="bg-green-50 rounded-lg p-2 text-xs text-green-700 mt-2">✓ Meets MoH NZ (2020) guidelines</div>
...
function ReportPage({ setCurrentPage, optimisationResult }) {
  ...
  const storeTextColors = {
    "Pak'nSave": "text-green-800",
    "New World": "text-orange-700",
    "Woolworths": "text-blue-700",
  };
  const dotColors = {
    "Pak'nSave": "bg-green-600",
    "New World": "bg-orange-500",
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <button onClick={handleDownloadPDF} className="bg-green-700 text-white px-5 py-2 rounded-xl text-sm font-medium flex items-center gap-2 hover:bg-green-800">
          ⬇️ Download PDF
        </button>
      </div>
